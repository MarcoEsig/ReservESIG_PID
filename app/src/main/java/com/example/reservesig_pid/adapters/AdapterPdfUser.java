...
import com.example.reservesig_pid.databinding.RowPdfUserBinding;
import com.example.reservesig_pid.filters.FilterPdfAdmin;
import com.example.reservesig_pid.filters.FilterPdfUser;
...
public class AdapterPdfUser extends RecyclerView.Adapter<AdapterPdfUser.HolderPdfUser> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull AdapterPdfUser.HolderPdfUser holder, int position) {
        ...
        String title = model.getCategoryId();
    ...
    public int getItemCount() {
        return pdfArrayList.size();  //nous retourne la taille de list du nombre de records
    }
